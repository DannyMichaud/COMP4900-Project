...
monitor.o: $(MONITOR_DIR)monitor.c $(MONITOR_DIR)monitor.h $(SHMEM_DIR)shared_memory.h $(PATIEENT_DIR)patient_vitals.h $(HOSPITAL_SYSTEM_DIR)hospital_system_messages.h  $(HOSPITAL_SYSTEM_DIR)hospital_system_address.h
