...
$(PATIENT_DIR)patient: $(PATIENT_DIR)patient.o $(PATIENT_DIR)patient_vitals.o $(PATIENT_DIR)shared_memory_helpers.o
...
shared_memory_helpers.o: $(PATIENT_DIR)shared_memory_helpers.c $(PATIENT_DIR)shared_memory.h
